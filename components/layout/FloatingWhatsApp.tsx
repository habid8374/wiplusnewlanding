...
export function FloatingWhatsApp({ numero }: { numero: string }) {
  ...
  return (
    <WhatsAppLink
      ...
      className="bg-whatsapp-500 fixed right-4 bottom-4 z-50 inline-flex size-14 items-center justify-center rounded-full text-white shadow-lg ring-4 ring-white transition-transform hover:scale-105 focus-visible:scale-105 sm:right-6 sm:bottom-6 sm:size-16"
    >
