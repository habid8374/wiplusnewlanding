...
export const cobertura: Municipio[] = [
  ...
  {
    id: 'municipio-aguada-de-pablo',
    slug: 'aguada-de-pablo',
    nombre: 'Aguada de Pablo',
    departamento: 'Atlántico',
    geo: null,
    whatsapp: null,
    barrios: [],
  ...
  {
    id: 'municipio-palmar-de-candelaria',
    slug: 'palmar-de-candelaria',
    nombre: 'Palmar de Candelaria',
    departamento: 'Atlántico',
    geo: null,
    whatsapp: null,
    barrios: [],
